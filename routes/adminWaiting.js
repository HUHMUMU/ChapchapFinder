...
router.get('/waiting.do', async (req, res) => {
    ...
    res.render("waitings/waiting", {
        ...
        EnterNotiToUserBtn: EnterNotiToUserBtn,
        getLastWaitingUser:getLastWaitingUser,
        CancelToUserBtn: CancelToUserBtn,
...
//         });
//
//         const waitingStats = Math.ceil(waitings.length / 4);
//         const teams = [];
//         for (let i = 0; i < teamCount; i++) {
//             teams.push(waitingStats.slice(i * 4, (i + 1) * 4));
//         }
//
